...
export default  function Home() {
  ...
  return (
    ...
    <section className="relative py-20">
        ...
        <p className="max-w-[700px] text-muted-foreground md:text-xl">Discover a new way to learn with our modern, interactive 
            learning management system. Access high-quality courses anytime, anywhere.</p>

            <div className="flex flex-col sd:flex-row gap-4 mt-8">
    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:grid-cols-4 gap-6 mb-32">
