...
export function Uploader({ onChange, value }: iAppProps): React.ReactElement {
   ...
   async function handleRemoveFile() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error(data.error || "Failed to remove file from storage");
        setFileState((prev) => ({
          ...prev,
          isDeleting: false,
          error: true,
  ...
  function renderContent (){
    ...
    if(fileState.objectUrl){
      return<RenderUploadedState handleRemoveFile={handleRemoveFile} 
